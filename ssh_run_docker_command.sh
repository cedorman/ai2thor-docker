...
ssh -i ~/.ssh/CED_Consulting_AWS_Key_Pair.pem ubuntu@ec2-52-91-116-180.compute-1.amazonaws.com docker run --privileged 924969863225.dkr.ecr.us-east-1.amazonaws.com/mcs-ai2thor-docker python3 mcs_test.py
